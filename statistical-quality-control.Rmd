...
$$ \text{probability of defective items drawn}=\frac{\text{combinations of non-conformative items drawn }\times\text{combinations of conformative items drawn}}{\text{combinations when number of drawing items equals to sample size}}$$

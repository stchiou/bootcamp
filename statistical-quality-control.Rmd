...
##### Differences between Binomial Distribution and Negative Binomial Distribution
...
- the most important distribution in both the theory and application of statistics
- a bell-shaped curve
#### Definition
- nomal random variable $x$ has the probability distribution of 
$$

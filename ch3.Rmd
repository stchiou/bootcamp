...
```{r}
days <- c(36,37,26,36,46,35,47,35,34,36,42,43,36,56,32,46,30,37,43,17,26,28,27,45,33,22,27,16,22,33,30,24,23,22,30,31,17)
stem(days)
```
# Histogram
...
bp <- boxplot(diameter, horizontal=TRUE, xlab="Hole Diameters (mm)")
